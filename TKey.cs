    ...
    public class StationWorkerCollection<TKey>
    {
        ...
        public void AddDefaults()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                stationWorker.PropertyChanged += StationWorker_PropertyChanged;
        ...
        private void StationWorker_PropertyChanged(object stationWorker, PropertyChangedEventArgs e)
        {
            TKey key = keySelector((StationWorker)stationWorker);

            OnWorkersChanged(new WorkersChangedEventArgs<TKey>(CollectionName, Update.Add, e.PropertyName, key));
        }
